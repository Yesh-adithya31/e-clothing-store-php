...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $stmt = $conn->prepare("INSERT INTO user(first_name, last_name, email, phone_number, password) VALUES(:fName,:lName, :email, :phone, :pass)");
        $stmt->execute(['fName' => $firstName, 'lName' => $lastName, 'email' => $email, 'phone' => $phoneNumber, 'pass' => $hashedPassword]);
