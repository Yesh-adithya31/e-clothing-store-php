...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare("SELECT * FROM order_details LEFT JOIN user ON order_details.user_id = user.user_id LEFT JOIN shipping_address ON shipping_address.shipping_add_id = order_details.shipping_address_id");
    $stmt->execute();
